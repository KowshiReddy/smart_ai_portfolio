...
Score each aspect from 0-100 based on industry best practices and real-world performance data.
Be specific in your recommendations and provide actionable insights.
Return the response in valid JSON format only, without extra text.`;
...
Provide a detailed analysis of the stack's viability, strengths, weaknesses, and recommendations. Return only valid JSON.`;
    ...
    const parsedResult = JSON.parse(responseText) as ValidationResult;
